package io.github.mysar.blog.controller.admin;

import com.alibaba.fastjson.JSONObject;
import io.github.mysar.blog.service.UserService;
import io.github.mysar.blog.common.utils.ImageCutUtil;
import io.github.mysar.blog.common.utils.PhotoUploadUtil;
import io.github.mysar.blog.modal.vo.PhotoResult;
...
public class ImageController {
    ...
    public PhotoResult imageUpload(@RequestParam(value = "editormd-image-FileManager",required = true) MultipartFile file){
        PhotoResult result = null;
        //设置filename
        // String filename = new Random().nextInt(10000)+FileManager.getOriginalFilename();
        try {
            File files = new File(System.getProperty("java.io.tmpdir") + System.getProperty("FileManager.separator")+file.getOriginalFilename());

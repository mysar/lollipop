...
public class PoiExcelExport {
    ...
    /**
     * Instantiates a new Poi excel export.
     *
     * @param fileDir   the FileManager dir
     ...
     * @param fileName  the FileManager name
     * @param sheetName the sheet name
     */
     ...
     * 设置表头字体.
     *
     * @param titleFontType the title font type
     */
     ...
     * 设置表头字体大小.
     *
     * @param titleFontSize the title font size
     */
     ...
     * 设置正文字体.
     *
     * @param contentFontType the content font type
     */
     ...
     * 设置正文字号.
     *
     * @param contentFontSize the content font size
     */
                    ...
                    for (int rowIndex = 1; rowIndex <= dataList.size(); rowIndex++) {
                        ...
                        for (int columnIndex = 0; columnIndex < titleColumn.length; columnIndex++) {
                            ...
                            if (!"".equals(title)) {  //字段不为空
                                ...
                                if (methodName.equals("getEnrollStatus")) {
                                    HashMap<String, String> enrollStatus = new HashMap<String, String>();
                                    enrollStatus.put("0", "未录取");
                                    enrollStatus.put("1", "已录取");
                                    enrollStatus.put("2", "预录");
                                    enrollStatus.put("3", "待录");
                                    enrollStatus.put("4", "待测试");
                                    returnType = "String";
                                    data = enrollStatus.get(data);
                                }
